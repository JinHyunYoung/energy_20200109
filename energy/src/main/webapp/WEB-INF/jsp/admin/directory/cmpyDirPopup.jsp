					...
					<div class="division">
						...
						<div class="table_area">
							<table class="write">
								...
								<tr>								
									<th scope="row">
										<label for="cmpy_nm">기업명(국문)<strong class="color_pointr">*</strong></label>
									</th>
									<td>
								...
								<tr>								
									<th scope="row">
										<label for="cmpy_nm_en">기업명(영문)<strong class="color_pointr">*</strong></label>
									</th>
									<td>
								...
								<tr>								
									<th scope="row">
										<label for="biz_reg_no">사업자번호<strong class="color_pointr">*</strong></label>
									</th>
									<td>
										<input type="text" name="biz_reg_no" id="biz_reg_no" value="${cmpyDir.biz_reg_no}" class="in_wp100" data-parsley-pattern="\d{3}-\d{2}-\d{5}" data-parsley-required="true" /> (ex:123-45-67890)
									</td>
								</tr>
								<tr>							
									<th scope="row">
										<label for="ceo_nm">대표자명(국문)<strong class="color_pointr">*</strong></label>
									</th>
									<td>
										<input type="text" name="ceo_nm" id="ceo_nm" value="${cmpyDir.ceo_nm}" class="in_wp100" data-parsley-maxlength="300" data-parsley-required="true" />
									</td>
								</tr>
								<tr>						
									<th scope="row">
										<label for="ceo_nm_en">대표자명(영문)<strong class="color_pointr">*</strong></label>
									</th>
									<td>
										<input type="text" name="ceo_nm_en" id="ceo_nm_en" value="${cmpyDir.ceo_nm_en}" class="in_wp100" data-parsley-maxlength="300" data-parsley-required="true" />
									</td>
								</tr>
								<tr>
									<th scope="row">
										설립년도<strong class="color_pointr">*</strong>
									</th>
									<td>
										<select class="in_wp80" id="est_yy" name="est_yy" data-parsley-errors-container="#email_error_est" data-parsley-required="true">
											<option value="" <c:if test="${cmpyDir.est_yy == ''}">selected</c:if> >-선택-</option>
										...
										<select class="in_wp80" id="est_mm" name="est_mm" data-parsley-errors-container="#email_error_est" data-parsley-required="true">
											<option value="" <c:if test="${cmpyDir.est_mm == ''}">selected</c:if> >-선택-</option>
								...
								<tr>
									<th scope="row">
										조직형태<strong class="color_pointr">*</strong>
									</th>
									<td>
								...
								<tr>
									<th scope="row">
										법인형태<strong class="color_pointr">*</strong>
									</th>
									<td>
								...
								<tr>
									<th scope="row">
										기업 디렉토리<br />(주업종)<strong class="color_pointr">*</strong>
									</th>
									<td>
										<table class="sectors">
										<caption>주업종</caption>
										...
										<tbody>
											<tr>
												<td>
													<g:select class="in_wp120" id="inds_tp_cd" name="inds_tp_cd" codeGroup="INDS_TP_CD" selected="${cmpyDir.inds_tp_cd}" cls="form-control" />  	
													...
													<tr>
														...
														<td>
															<button class="btn" onclick="javascript:deleteCmpyDirCslfRow(this)" title="삭제">
																<img src="/images/admin/common/btn_file_delete.png" alt="삭제" />
															</button>
														</td>
													</tr>
												</c:forEach>
												<tr id="emptyRow">
													<td colspan="5">
														<button class="btn" onclick="javascript:insertCmpyDirCslfRow()" title="추가">
															<img src="/images/admin/common/btn_file_add.png" alt="추가" />
														</button>
													</td>
												</tr>
										</tbody>
								...
								<tr>
									<th scope="row">
										<label for="empl_cnt">사원 수(명)</label>
									</th>
									<td>
										<input type="text" name="empl_cnt" id="empl_cnt" value="${cmpyDir.empl_cnt}" class="in_wp100" data-parsley-maxlength="10" data-parsley-type="integer"/>
									</td>
								</tr>
								<tr>
									<th scope="row">
									...
									<td>
										<input type="text" name="url" id="url"  value="${cmpyDir.url}" class="in_w80" data-parsley-maxlength="300" data-parsley-type="url" />
									</td>
								</tr>
								<tr>
									<th scope="row">
									...
									<td>
										<select id="tel_1" name="tel_1" class="in_wp80">	
								...
								<tr>
									...
									<td>
										<select id="fax_1" name="fax_1" class="in_wp80">
								...
								<tr>
									...
									<td>
										<div class="">
											...
											<button class="btn active" title="주소찾기" onclick="javascript:jusoPopupShow();" >
												<span>주소찾기</span>
											</button>
										</div>
										<div class="margint5">
											<input type="text" name="addr1" id="addr1" value="${cmpyDir.addr1}" class="in_w30" data-parsley-maxlength="300" />
											<label for="addr1" class="hidden">기본주소</label>
											<input type="text" name="addr2" id="addr2" value="${cmpyDir.addr2}" class="in_w30" data-parsley-maxlength="300" />
								...
								<tr>
									...
									<td>
										<input type="text" name="addr1_en" id="addr1_en" value="${cmpyDir.addr1_en}" class="in_w30" data-parsley-maxlength="300" />
										<label for="addr1_en" class="hidden">기본주소</label>
										<input type="text" name="addr2_en" id="addr2_en" value="${cmpyDir.addr2_en}" class="in_w30" data-parsley-maxlength="300" />
										<label for="addr2_en" class="hidden">상세주소</label>
									</td>
								</tr>
								<tr>
									<th scope="row">
								...
								<tr>
									...
									<td>
										<input type="radio" name="member_yn" id="member_yn_y" value="Y" class="" <c:if test="${cmpyDir.member_yn eq 'Y'}">checked="checked"</c:if> />
										<label for="member_yn_y">회원사</label>
										<input type="radio" name="member_yn" id="member_yn_n" value="N" class="marginl10" <c:if test="${cmpyDir.member_yn ne 'Y'}">checked="checked"</c:if> />
										<label for="member_yn_n">비회원사</label>
									</td>
								</tr>
								<tr>
									<th scope="row">
								...
								<tr>
									<th scope="row">
										<label for="auth_no">인증번호<strong class="color_pointr">*</strong></label>
									</th>
									<td>
										<input type="text" name="auth_no" id="auth_no" value="${cmpyDir.auth_no}" class="in_wp120" data-parsley-maxlength="100" data-parsley-required="true" />
									</td>
								</tr>
								<tr>
									<th scope="row">
									...
									<td>										
										<input type="radio" name="opn_yn" id="opn_yn_y" value="Y" class="" <c:if test="${cmpyDir.opn_yn eq 'Y'}">checked="checked"</c:if> />
										<label for="opn_yn_y">공개</label>
										<input type="radio" name="opn_yn" id="opn_yn_n" value="N" class="marginl10" <c:if test="${cmpyDir.opn_yn ne 'Y'}">checked="checked"</c:if> />
