...
function insertCmpyDirHstrRow(){
	...
	if ( $("#cmpyDirHstrFormRow").parsley().validate() ){
		...
		str += '<tr>';
		str += '	<td id="hstr_yy_label" class="alignc">' + hstr_yy + '년</td>';
		str += '	<td id="hstr_mm_label" class="alignc">' + hstr_mm + '월</td>';
		str += '	<td id="hstr_cn_label" class="alignl">' + hstr_cn + '</td>';
				...
				<div class="division">
					...
					<form id="cmpyDirHstrForm" name="cmpyDirHstrForm" method="post" onsubmit="return false;">
						...
						<div class="title_area">
							<h2 class="pop_title">연혁</h4>
						</div>
						<!--// title_area -->
						
						<!-- table_area -->
						<div class="table_area">
							<table id="cmpyDirHstrTable" class="list" style="min-width: 500px">
								<caption>연혁 화면</caption>
								<colgroup>
									<col style="width: 15%;">
									<col style="width: 12%;">
									<col style="width: *;">
...
<%-- 											<td id="hstr_yy_label" class="alignc" >${list.hstr_yy}년</td> --%>
											<td id="hstr_mm_label" class="alignc">${list.hstr_mm}월</td>
											<td id="hstr_cn_label" class="alignl"><a title="연혁" href="#" id="selectRow" name="selectRow">${list.hstr_cn}</a></td>	
						...
						<div id="dataRowTitleDiv" class="title_area" style="display: none">
							<h2 class="pop_title">연혁 등록/수정</h4>
						</div>
						<!--// title_area -->
						...
						<div id="dataRowTableDiv" class="table_area" style="display: none">
							...
							<table class="write">
								...
								<tbody>
									<tr>
										<th scope="row">
											년도/월<strong class="color_pointr">*</strong>
										</th>
										<td>
									...
									<tr>
										<th scope="row">
											<label for="cn">내용(국문)<strong class="color_pointr">*</strong></label>
										</th>
										<td>
											<textarea class="in_w100" rows="5" id="cn" name="cn" title="내용(국문) 입력" data-parsley-maxlength="300" data-parsley-required="true"></textarea>
										</td>
									</tr>
									<tr>
										<th scope="row">
											<label for="cn_en">내용(영문)</label>
										</th>
										<td>
											<textarea class="in_w100" rows="5" id="cn_en" name="cn_en" title="내용(영문) 입력" data-parsley-maxlength="300" ></textarea>
										</td>
									</tr>
								</tbody>
							</table>
					...
					<div id="sub_btn" class="button_area">
						<div class="alignr">
							<button class="btn save" title="저장" onClick="javascript:insertCmpyDirHstrRow()">
								<span>저장</span>
							</button>
