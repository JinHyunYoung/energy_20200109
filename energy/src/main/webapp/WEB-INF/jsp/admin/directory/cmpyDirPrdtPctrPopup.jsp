				...
				<div class="division">				
					...
					<form id="cmpyDirPrdtPctrForm" name="cmpyDirPrdtPctrForm" method="post" enctype="multipart/form-data" onsubmit="return false;">
						...
						<div class="title_area">
							<h2 class="pop_title">제품사진</h4>
						</div>
						<!--// title_area -->
						
						<!-- table_area -->
						<div class="table_area">
							<table id="cmpyDirPrdtPctrTable" class="list" style="min-width: 500px">
								<caption>제품사진 화면</caption>
								<colgroup>
									<col style="width: 20%;">
									<col style="width: *;">
								</colgroup>
								<thead>
									<tr>
										...
										<th scope="col">제품명(국문/영문)</th>
									</tr>
								</thead>
								<tbody>
									<c:forEach items="${cmpyDirPrdtPctrList}" var="list" varStatus="status">
										<tr>
											<td id="prdt_file_id_label">
												<a title="인증상세" href="#" id="selectRow" name="selectRow">
												...
												<c:if test="${empty list.prdt_file_id_nm}">
													<img src="/images/admin/common/detail_no_img.png" width="100" height="100" alt="이미지 없음" class="info_img" />
												</c:if>
												</a>
											</td>
											<td id="prdt_nm_label">
												<p class="product_kor_name">${list.prdt_nm}</p>
												<p class="product_eng_name">${list.prdt_nm_en}</p>
											</td>
						...
						<div id="dataRowTitleDiv" class="title_area" style="display: none">
							<h2 class="pop_title">제품사진 등록/수정</h4>
						</div>
						<!--// title_area -->
						...
						<div id="dataRowTableDiv" class="table_area" style="display: none">
							...
							<table class="write">
								...
								<tbody>
									<tr>
										<th scope="row">
											<label for="prdt_nm">제품명(국문)<strong class="color_pointr">*</strong></label>
										</th>
										<td>
											<input type="text" id="prdt_nm" name="prdt_nm" class="in_w98" data-parsley-maxlength="300" data-parsley-required="true"/>
										</td>
									</tr>
									<tr>
										<th scope="row">
											<label for="prdt_nm_en">제품명(영문)</strong></label>
										</th>
										<td>
											<input type="text" id="prdt_nm_en" name="prdt_nm_en" class="in_w98" data-parsley-maxlength="300" />
										</td>
									</tr>
									<tr>
										<th scope="row">제품사진</th>
										<td>
											<div class="file_area">
