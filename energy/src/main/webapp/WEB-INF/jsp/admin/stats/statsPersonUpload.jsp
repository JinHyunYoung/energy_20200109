...
var excelValidUrl = '<c:url value="/admin/stats/statsPersonValid.do" />';
var excelUploadUrl = '<c:url value="/admin/stats/statsPersonResult.do" />';
...
<div id="content">
	...
	<div class="title_and_info_area">
		...
		<div class="main_title">
			<h3 class="title">통계 모집단 명부 일괄등록</h3>
		</div>
		<!--// main_title -->
	...
	<form id="excelFrm" name="excelFrm" method="post" data-parsley-validate="true" enctype="multipart/form-data">
		...
		<div class="search_area">
			<table class="search_box">
				<caption>통계 모집단 명부 일괄등록 화면</caption>
				<colgroup>
				...
				<tr>
					<th scope="row">통계 모집단 명부 파일 선택<strong class="color_pointr">*</strong></th>
					<td>
	...
	<div class="information_area">
		<section>
			...
			<ul class="information">
				...
				<li>
					<span>5. 샘플파일을 참고하여 작성하여 주십시요. (<a href="/contents/template/template_excel_person.xlsx" title="샘플파일다운로드">샘플파일다운</a>)</span>
				</li>
			</ul>
		</section>
	</div>
