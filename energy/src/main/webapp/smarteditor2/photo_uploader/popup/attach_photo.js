    ...
    function html5Upload() {	
    	...
    	sUploadURL= "/smarteditor2/photo_uploader/popup/file_uploader_html5.jsp";
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : "/smarteditor2/photo_uploader/popup/file_uploader_html.jsp", //location.href.replace(/\/[^\/]*$/, '') + '/file_uploader.php',	//샘플 URL입니다.
 	        sCallback : "/smarteditor2/photo_uploader/popup/callback.html",//location.href.replace(/\/[^\/]*$/, '') + '/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
