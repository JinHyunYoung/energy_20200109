/*! =======================================================
 * File Input to Image Button - JQuery Plugin
 *
 *       Repo : https://github.com/e2xist/jquery-sh-file-input-image
 *    Version : 1.1.1
...
(function($) {
	...
	var methods = {
		...
		debug: function(options, message){
			...
			{
				console.log("[JQueryImageInput]"+message);
			}
		},
		getBrowser : function(){
			var Browser = {
	...
	$.extend($.fn, {
		shFileInputImage : function(options)
		{
			//set default options
			var defaults = {
				image    : "none",
			...
			if(typeof options === 'object'){
				...
				methods.debug(options,"merge Options");
			} else {
				options = defaults;
			}
